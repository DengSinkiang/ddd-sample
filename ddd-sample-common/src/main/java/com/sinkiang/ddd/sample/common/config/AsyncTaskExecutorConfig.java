package com.sinkiang.ddd.sample.common.config;
...
public class AsyncTaskExecutorConfig {
     ...
     * 线程前缀
     */
    private static final String THEAD_NAME_PREFIX = "asyncTaskExecutor-";
    /**
     * 阻塞队列
     */
    ...
    public ThreadPoolTaskExecutor asyncTaskExecutor() {
        ...
        // 线程前缀
        threadPoolTaskExecutor.setThreadNamePrefix(THEAD_NAME_PREFIX);
        // 核心线程数
